...
public entry point layers small wrappers on top of it so preferences and shared
CSV/export helpers are used without changing imports such as
``from dpo4000_utils.gui.app import ScopeGui``.
"""

from __future__ import annotations

from .waveform_window import WaveformScopeGui as ScopeGui
