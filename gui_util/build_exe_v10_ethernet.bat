...
set MAIN_FILE=tektronix_scope_gui_v10_ethernet.py
...
echo.
echo Note: the target PC still needs a VISA runtime/backend for USB or Ethernet VISA.
echo Examples: NI-VISA, TekVISA, or Keysight VISA.
pause
