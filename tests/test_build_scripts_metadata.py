...
def test_project_version_and_desktop_metadata_are_current():
    ...
    changelog_entry = Path("CHANGELOG.d/v0.6.6.md").read_text(encoding="utf-8")
    ...
    assert "# v0.6.6 - 2026-08-31" in changelog_entry
    assert "Package version bumped to `0.6.6`" in changelog_entry
